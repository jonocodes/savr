(async function () {
  ...
  // the bookmarklet used will fetch and execute this code. so in effect this will be run on the article page being collected and communicate to the PWA. and it talks to the extensionConnector.ts script in the app.
