// I think this is the code that should be in the PWA
...
class ExtensionConnector {
  ...
  private async handleResourcesResponse(
    ...
    try {
      ...
      console.error("Error handling resources response:", error);

      // Send error response to the original request if available
